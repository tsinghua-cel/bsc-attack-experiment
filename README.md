...
|-------------------------------------------------|---------------------------------------------------------------------------------|
| The latest block height                      | The number of the latest block that has been generated by the current node (`LatestBlock`).    |
 Finalized block height                      | Block number that has been finalized (`FinalizedBlock`).    |
| Attestation of block header                      | `true` means that the block received a vote attestation, `false` means that it did not.    |
