...
### Calculate the number of #Blocks and finalization rate (FR)

```bash
python count_FR.py "3.2.txt" --min 251 --max 2251  # "3.2.txt" is the name of the output file to be calculated, "--min" and "--max" are the upper and lower limits of the calculated height.
```
